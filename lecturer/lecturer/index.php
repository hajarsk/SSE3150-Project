...
<html>
 <head>
  ...
  <title>FSKTM Lectures Attendance Management</title>
 ...
 <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"> FSKTM Online Lectures Attendance </a>
        </div>
  ...
  <div class="container">
    <h2>For Students</h2>
    <h4>If you are a student, <a href="student.php">click here</a> to check your attendance</h4>
    <hr>
    <h2>FSKTM Lecturers</h2>
