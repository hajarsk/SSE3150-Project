    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #ff2020; border-color: #ddacac; ">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" a style="color: #fff;">Online Attendance</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a a style="color: #fff;" href="teacher.php">Dashboard</a></li>
			<li  class="active"><a a style="color: #fff;" href="profile.php">Profile</a></li>

			<li><a a style="color: #fff;" href="statistics.php">Statistics</a></li>
			<li><a a style="color: #fff;" href="logout.php">Logout</a></li>
