    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #ff2020; border-color: #ddacac; ">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" style="color: #fff;">Online Attendance</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a  style="color: #fff;"href="teacher.php">Dashboard</a></li>
			<li><a  style="color: #fff;"href="profile.php">Profile</a></li>

			<li class="active"><a style="color: #fff;"href="statistics.php">Statistics</a></li>
