      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
			...
			<li><a style="color: #fff;"href="statistics.php">Statistics</a></li>
  ...
  <div class="container">
    <?php
      ...
      if(!$classes) {
        ...
        echo '<h3 class="no-classes">Select on a class to take attendance.</h3>';
        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <?php foreach(range(date('Y',time()),2019) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <input class="form-control" name="code" placeholder="Code , Eg - COE-216">
